...
export function CommentSection({ postId }: CommentSectionProps) {
  ...
  const { data: comments, isLoading } = useGalleryComments(postId);
  const { mutate: postComment, isPending } = usePostGalleryComment(postId);
...
function CommentItem({
  ...
  const { mutate: updateComment, isPending: isUpdating } = useUpdateGalleryComment(postId);
  const { mutate: removeComment, isPending: isDeleting } = useDeleteGalleryComment(postId);
